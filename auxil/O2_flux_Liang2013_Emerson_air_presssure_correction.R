...
O2_flux_Liang2013_Emerson_air_presssure_correction=function (windspeed =float_profile_merge$wind_speed, 
  ...
  F_total <-  Fs*(1+  ks_oxygen_error) + (Fp + Fc) *0.37 *(1+  kb_oxygen_error)
...
###氧气饱和度公式  Herncin E. Garcfa 1992  （umol kg
o2sat=function(S,T){
